...
if (Object.keys(newErrors).length === 0) {
  //diff-add-start
  // Print the form data to console instead of saving to IndexedDB
...
- We gather all the form data (`tripDate`, `weather`, `startTime`) into a single object
...
1. Fill out all the form fields (Date, Time, Weather)
...
![Form Data Console Output](./src/assets/step-4.2.png)
