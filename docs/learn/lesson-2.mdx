...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=241
...
1. **Initial State with `defaultValue`**:
   ...
   ```jsx title="src/pages/StartTrip.jsx" showLineNumbers=69
...
2. **Updating State with `onChange`**:
   ...
   ```jsx title="src/pages/StartTrip.jsx" showLineNumbers=147
...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=264
// diff-add-start
<FormGroup>
...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=243
// diff-add-start
<Form onSubmit={handleSubmit} large>
  <FormGroup>
    <Label
...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=198
