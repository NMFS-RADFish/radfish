...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=190
...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=166
...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=274
//diff-remove-start
<FormGroup>
//diff-remove-end
//diff-add-start
...
```jsx title="src/pages/CatchLog.jsx" showLineNumbers=287
const handleSubmit = async (e) => {
  e.preventDefault();
...
```jsx title="src/pages/CatchLog.jsx" showLineNumbers=202
...
```jsx title="src/pages/CatchLog.jsx" showLineNumbers=562
