...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=154
...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=256
//diff-remove-start
<FormGroup>
//diff-remove-end
//diff-add-start
...
```jsx title="src/pages/StartTrip.jsx" showLineNumbers=257
<FormGroup error={errors.tripDate}>
  <Label
    htmlFor="tripDate"
    error={errors.tripDate}
...
```jsx title="src/pages/CatchLog.jsx" showLineNumbers=464
//diff-remove-start
<FormGroup >
//diff-remove-end
//diff-add-start
