...
4. `handleSubmit` - For adding new catches
5. `handleMainSubmit` - For proceeding to the next step
...
<Form onSubmit={() => {}}>  {/* Replace with: onSubmit={handleSubmit} */}
...
//diff-remove-end
//diff-add-start
<Form onSubmit={handleSubmit} large className="margin-top-3 width-full">
//diff-add-end
